...
class BasePlotter:
    def __init__(self, mode = "custom", systematic = "nominal", baseObjectName = "hh_llmetjj_allTight_btagM_csv", WP = ["T", "T", "T", "T", "L", "L", "M", "M", "csv"]):
    ...
    def generatePlots(self, dict_cat_cut = {}):
        ...
        for cat in dict_cat_cut.keys() :
            ...
            self.totalCut = self.joinCuts(self.sanityCheck, self.catCut, self.jetCut, self.lepCut, self.extraCut)
            self.llFlav = cat

            self.plots_lep.extend([
                {
                    'name':  'lep1_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': self.lep1_str+".p4.Pt()",
                    'plot_cut': self.totalCut,
                    'binning': '(50, 0, 300)'
                },
                {
                    'name':  'lep1_eta_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': self.lep1_str+".p4.Eta()",
                    'plot_cut': self.totalCut,
                    'binning': '(25, -2.5, 2.5)'
                },
                {
                    'name':  'lep1_phi_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': self.lep1_str+".p4.Phi()",
                    'plot_cut': self.totalCut,
                    'binning': '(25, -3.1416, 3.1416)'
                },
                #{
                #    'name':  'lep1_scaleFactor_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                #    'variable': get_lepton_SF(self.lep1_str, self.lepid1, self.lepiso1, "nominal"),
                #    'plot_cut': self.totalCut,
                #    'binning': '(50, 0.8, 1.2)'
                #},
                {
                    'name':  'lep1_Iso_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "({0}.isEl) ? electron_relativeIsoR03_withEA[{1}] : muon_relativeIsoR04_deltaBeta[{1}]".format(self.lep1_str, self.lep1_fwkIdx),
                    'plot_cut': self.totalCut,
                    'binning': '(50, 0, 0.4)'
                },
                {
                    'name':  'lep2_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': self.lep2_str+".p4.Pt()",
                    'plot_cut': self.totalCut,
                    'binning': '(50, 0, 100)'
                },
                {
                    'name':  'lep2_eta_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': self.lep2_str+".p4.Eta()",
                    'plot_cut': self.totalCut,
                    'binning': '(25, -2.5, 2.5)'
                },
                {
                    'name':  'lep2_phi_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': self.lep2_str+".p4.Phi()",
                    'plot_cut': self.totalCut,
                    'binning': '(25, -3.1416, 3.1416)'
                },
                #{
                #    'name':  'lep2_scaleFactor_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                #    'variable': get_lepton_SF(self.lep2_str, self.lepid2, self.lepiso2, "nominal"),
                #    'plot_cut': self.totalCut,
                #    'binning': '(50, 0.8, 1.2)'
                #},
                {
                    'name':  'lep2_Iso_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
            ...
            self.plots_jet.extend([ 
                {
                        'name':  'jet1_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 300)'
                },
                {
                        'name':  'jet1_eta_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".p4.Eta()",
                        'plot_cut': self.totalCut,
                        'binning': '(25, -2.5, 2.5)'
                },
                {
                        'name':  'jet1_phi_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".p4.Phi()",
                        'plot_cut': self.totalCut,
                        'binning': '(25, -3.1416, 3.1416)'
                },
                {
                        'name':  'jet1_JP_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".JP",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.5)'
                },
                {
                        'name':  'jet1_CSV_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".CSV",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 1)'
                },
                {
                        'name':  'jet2_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet2_str+".p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 250)'
                },
                {
                        'name':  'jet2_eta_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet2_str+".p4.Eta()",
                        'plot_cut': self.totalCut,
                        'binning': '(25, -2.5, 2.5)'
                },
                {
                        'name':  'jet2_phi_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet2_str+".p4.Phi()",
                        'plot_cut': self.totalCut,
                        'binning': '(25, -3.1416, 3.1416)'
                },
                {
                        'name':  'jet2_JP_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet2_str+".JP",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.5)'
                },
                {
                        'name':  'jet2_CSV_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet2_str+".CSV",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 1)'
                },
                #{
                #        'name':  'jet1_scaleFactor_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                #        'variable': get_csvv2_sf(self.btagWP1, self.jet1_fwkIdx),
                #        'plot_cut': self.totalCut,
                #        'binning': '(50, 0.5, 1.5)'
                #},
                #{
                #        'name':  'jet2_scaleFactor_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
            ...
            self.plots_met.extend([ 
                {
                        'name':  'met_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "met_p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 400)'
                },
                {
                        'name':  'met_phi_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "met_p4.Phi()",
                        'plot_cut': self.totalCut,
                        'binning': '(25, -3.1416, 3.1416)'
                }
            ...
            self.plots_ll.extend([ 
                {
                        'name':  'll_M_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.ll_str+".p4.M()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 250)'
                },
                {
                        'name':  'll_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.ll_str+".p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 400)'
                },
                {
                        'name':  'll_DR_l_l_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.ll_str+".DR_l_l",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 6)'
                },
                {
                        'name':  'll_DPhi_l_l_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.ll_str+".DPhi_l_l)",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.1416)'
                },
                #{
                #        'name':  'll_scaleFactor_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
            ...
            self.plots_jj.extend([ 
                {
                        'name':  'jj_M_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jj_str+".p4.M()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 600)'
                },
                {
                        'name':  'jj_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jj_str+".p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 400)'
                },
                {
                        'name':  'jj_DR_j_j_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jj_str+".DR_j_j",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 6)'
                },
                {
                        'name':  'jj_DPhi_j_j_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.jj_str+".DPhi_j_j)",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.1416)'
                },
                {
                        'name':  'jj_CSVprod_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".CSV * " + self.jet2_str+".CSV",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 1)'
                },
                {
                        'name':  'jj_CSVsum_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.jet1_str+".CSV + " + self.jet2_str+".CSV",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 2)'
                },
                #{
                #        'name':  'jj_scaleFactor_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
            ...
            self.plots_llmetjj.extend([ 
                #{
                #        'name':  'llmetjj_n_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                #        'variable': "Length$(%s)"%self.mapIndices,
                #        'plot_cut': self.totalCut,
                #        'binning': '(18, 0, 18)'
                #},
                {
                        'name':  'llmetjj_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 250)'
                },
                {
                        'name':  'llmetjj_M_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".p4.M()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 1000)'
                },
                {
                        'name':  'llmetjj_DPhi_ll_met_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.baseObject+".DPhi_ll_met)",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_minDPhi_l_met_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".minDPhi_l_met",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_maxDPhi_l_met_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".maxDPhi_l_met",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_MT_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".MT", # ll[ill].p4 + met[imet].p4).M()
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 600)'
                },
                {
                        'name':  'llmetjj_MTformula_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".MT_formula", # std::sqrt(2 * ll[ill].p4.Pt() * met[imet].p4.Pt() * (1-std::cos(dphi)));
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 500)'
                },
                {
                        'name':  'llmetjj_projMET_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.baseObject+".projectedMet)",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 400)'
                },
                {
                        'name':  'llmetjj_DPhi_jj_met_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.baseObject+".DPhi_jj_met)",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_minDPhi_j_met_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".minDPhi_j_met",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_maxDPhi_j_met_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".maxDPhi_j_met",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_maxDR_l_j_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".maxDR_l_j",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 6)'
                },
                {
                        'name':  'llmetjj_minDR_l_j_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".minDR_l_j",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 6)'
                },
                {
                        'name':  'llmetjj_DR_ll_jj_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".DR_ll_jj",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 6)'
                },
                {
                        'name':  'llmetjj_DR_llmet_jj_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".DR_llmet_jj",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 6)'
                },
                {
                        'name':  'llmetjj_DPhi_ll_jj_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.baseObject+".DPhi_ll_jj)",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_DPhi_llmet_jj_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.baseObject+".DPhi_llmet_jj)",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 3.1416)'
                },
                {
                        'name':  'llmetjj_cosThetaStar_CS_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': "abs("+self.baseObject+".cosThetaStar_CS)",
                        'plot_cut': self.totalCut,
                        'binning': '(25, 0, 1)'
                },
                {
                        'name':  'lljj_pt_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                        'variable': self.baseObject+".lljj_p4.Pt()",
                        'plot_cut': self.totalCut,
                        'binning': '(50, 0, 500)'
                },
                {
                        'name':  'lljj_M_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
...
#                {
#                    'name':  'nLep_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
...
#                },
#                {
#                    'name':  'nJet_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
...
#            ])
            self.forSkimmer.extend([
                {
                    'name':  'event_weight_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "event_weight",
                    'plot_cut': self.totalCut,
                    'binning': '(500, -10000, 10000)'
                },
                #{
                #    'name':  'total_weight_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                ...
                #},
                {
                    'name':  'event_pu_weight_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "event_pu_weight",
                    'plot_cut': self.totalCut,
                    'binning': '(50, 0, 6)'
                },
                {
                    'name':  'isElEl_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "%s.isElEl"%self.ll_str,
                    'plot_cut': self.totalCut,
                    'binning': '(2, 0, 2)'
                },
                {
                    'name':  'isMuMu_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "%s.isMuMu"%self.ll_str,
                    'plot_cut': self.totalCut,
                    'binning': '(2, 0, 2)'
                },
                {
                    'name':  'isElMu_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "%s.isElMu"%self.ll_str,
                    'plot_cut': self.totalCut,
                    'binning': '(2, 0, 2)'
                },
                {
                    'name':  'isMuEl_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "%s.isMuEl"%self.ll_str,
                    'plot_cut': self.totalCut,
                    'binning': '(2, 0, 2)'
                },
                {
                    'name':  'event_number_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "event_event",
                    'plot_cut': self.totalCut,
                    'binning': '(300, 0, 300000)'
                },
                {
                    'name':  'event_run_%s_%s%s'%(self.llFlav, self.suffix, self.systematicString),
                    'variable': "event_run",
                    'plot_cut': self.totalCut,
                    'binning': '(300, 0, 300000)'
                }
