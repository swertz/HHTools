...
n_background, n_signal = plotTools.drawNNOutput(training_background_predictions, testing_background_predictions,
             ...
             output_dir=output_folder, output_name="nn_output_%s.pdf" % suffix)

plotTools.draw_roc(n_signal, n_background, output_dir=output_folder, output_name="roc_curve_%s.pdf" % suffix)
print("Done")
